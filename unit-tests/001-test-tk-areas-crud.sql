...
BEGIN
    ...
    TICKETS.TK_AREAS_CRUD_PKG.TK_AREAS_CREAR_P(
        ...
        p_descripcion           => 'ÃƒÂrea creada por prueba unitaria.',
    ...
    afirmar(v_resultado LIKE 'OK:%', 'crear ÃƒÂ¡rea vÃƒÂ¡lida');
    ...
    CLOSE v_cursor;
    afirmar(v_id_generado = v_id_area, 'consultar ÃƒÂ¡rea por ID');
    ...
    TICKETS.TK_AREAS_CRUD_PKG.TK_AREAS_ACTUALIZAR_P(
        ...
        p_descripcion           => 'DescripciÃƒÂ³n actualizada por prueba unitaria.',
    ...
    afirmar(v_resultado LIKE 'OK:%', 'actualizar ÃƒÂ¡rea vÃƒÂ¡lida');
    ...
    afirmar(v_resultado LIKE 'OK:%', 'eliminar ÃƒÂ¡rea');

    v_cursor := TICKETS.TK_AREAS_CRUD_PKG.TK_AREAS_CONSULTAR_F(v_id_area);
    FETCH v_cursor INTO v_id_generado, v_nombre, v_descripcion,
                        v_fecha_creacion, v_usuario_creacion,
                        v_fecha_actualizacion, v_usuario_actualizacion, v_activa;
    afirmar(v_cursor%NOTFOUND, 'no devolver ÃƒÂ¡rea eliminada');
    CLOSE v_cursor;
...
EXCEPTION
    WHEN OTHERS THEN
        IF v_cursor%ISOPEN THEN
            CLOSE v_cursor;
        END IF;
        DBMS_OUTPUT.PUT_LINE('=== PRUEBA TK_AREAS FALLÃƒâ€œ ===');
        RAISE;
END;
/
